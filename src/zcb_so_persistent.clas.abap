class ZCB_SO_PERSISTENT definition
  public
...
public section.
  ...
  methods CREATE_PERSISTENT
    ...
    returning
      value(RESULT) type ref to ZCL_SO_PERSISTENT
    raising
...
protected section.
  ...
  types TYP_OBJECT_REF type ref to ZCL_SO_PERSISTENT .
  types:
...
CLASS ZCB_SO_PERSISTENT IMPLEMENTATION.


  method CREATE_PERSISTENT.
***BUILD 093901
*      IMPORTING I_VBELN TYPE VBELN_VA
*      RETURNING RESULT TYPE REF TO ZCL_SO_PERSISTENT
************************************************************************
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_SO_PERSISTENT,
...
*<  Generated from mapping:
    ...
    OBJECT_DATA_ITEM-VBTYP = THE_OBJECT->VBTYP.
*>
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_SO_PERSISTENT.
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type ZSALES_INFO.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB_ZSALES_INFO> type ZSALES_INFO.
*>

*< Generated from mapping:
  select * from ZSALES_INFO
           into table DB_DATA_LOCAL_TAB
           for all entries in I_BUSINESS_KEY_TAB
           where ZSALES_INFO~VBELN = I_BUSINESS_KEY_TAB-VBELN.
*>
...
* * error handling
  if ( SY-SUBRC <> 0 ).
    ...
    raise exception type CX_OS_DB_SELECT
         exporting TABLE  = 'ZSALES_INFO'
                   TEXTID = CX_OS_DB_SELECT=>BY_BKEYTAB.
  endif. "( Error )

  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.

    assign <FS_DB_DATA_LOCAL> to <FS_DB_ZSALES_INFO>.

*< Generated from mapping:
    DB_DATA-VBELN = <FS_DB_ZSALES_INFO>-VBELN.
    DB_DATA-KUNNR = <FS_DB_ZSALES_INFO>-KUNNR.
    DB_DATA-VBTYP = <FS_DB_ZSALES_INFO>-VBTYP.
*>
...
* * ZSALES_INFO: internal tables for mass operation
  data DB_ITB_ZSALES_INFO type STANDARD TABLE OF ZSALES_INFO.
  data DB_UTB_ZSALES_INFO type STANDARD TABLE OF ZSALES_INFO.
  data DB_DTB_ZSALES_INFO type STANDARD TABLE OF ZSALES_INFO.

* * ZSALES_INFO: headlines for tables
  data DB_ILN_ZSALES_INFO type ZSALES_INFO.
  data DB_ULN_ZSALES_INFO type ZSALES_INFO.
  data DB_DLN_ZSALES_INFO type ZSALES_INFO.
...
*< Generated from mapping:
   ...
   DB_ILN_ZSALES_INFO-KUNNR = <FS_INSERT>-KUNNR.
   DB_ILN_ZSALES_INFO-VBTYP = <FS_INSERT>-VBTYP.


   DB_ILN_ZSALES_INFO-VBELN = <FS_INSERT>-VBELN.
   append DB_ILN_ZSALES_INFO to DB_ITB_ZSALES_INFO.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_ZSALES_INFO-KUNNR = <FS_UPDATE>-KUNNR.
   DB_ULN_ZSALES_INFO-VBTYP = <FS_UPDATE>-VBTYP.


   DB_ULN_ZSALES_INFO-VBELN = <FS_UPDATE>-VBELN.
   append DB_ULN_ZSALES_INFO TO DB_UTB_ZSALES_INFO.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_ZSALES_INFO-VBELN = <FS_DELETE>-BUSINESS_KEY-VBELN.

    append DB_DLN_ZSALES_INFO TO DB_DTB_ZSALES_INFO.
...
* * DB Deletes
  delete ZSALES_INFO FROM TABLE DB_DTB_ZSALES_INFO.
  if SY-SUBRC <> 0.
...
* * DB Inserts
  insert ZSALES_INFO FROM TABLE DB_ITB_ZSALES_INFO
...
* * DB Updates
  update ZSALES_INFO FROM TABLE DB_UTB_ZSALES_INFO.
  if SY-SUBRC <> 0.
...
*<  Generated from mapping:
  ...
  THE_OBJECT->VBTYP = I_OBJECT_DATA-VBTYP.
*>
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_SO_PERSISTENT.
